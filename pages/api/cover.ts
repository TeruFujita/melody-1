...
async function getSpotifyImageUrl(trackId?: string, albumId?: string): Promise<string | null> {
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // 2. AI生成URLの有効性チェック
  if (aiImageUrl && typeof aiImageUrl === 'string' && await isValidImageUrl(aiImageUrl)) {
